...
export const flowbiteTheme: CustomFlowbiteTheme = createTheme({
  checkbox: {
    root: {
      color: {
        default:
          'border-gray-300 bg-gray-50 focus:ring-primary-300 dark:border-gray-600 dark:bg-gray-700 ' +
  ...
  sidebar: {
    ...
    item: {
      ...
      label:
        'ml-3 inline-flex h-5 w-5 items-center justify-center rounded-full bg-primary-100 p-1 ' +
  ...
  textarea: {
    ...
    colors: {
      gray: twMerge(
        ...
        'text-base focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:focus:border-blue-500 ' +
