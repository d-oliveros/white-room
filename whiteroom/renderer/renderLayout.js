...
<html>
  ...
  <head>
    ...
    <!-- Bundle Stylesheets -->
    ${bundleStyleSrc ? `<link rel="stylesheet" href="${bundleStyleSrc}"/>` : ''}
  ...
  <body>
    ...
    <div id="scripts">
      ...
      <!-- Bundle -->
      ${bundleSrc ? `<script src="${bundleSrc}"></script>` : ''}

      <!-- Development scripts -->
      ${!useBuild ? `<script src="${devScriptBaseUrl}:${webpackDevelopmentServerPort || 8001}/dist/bundle.js"></script>` : ''}
    </div>
